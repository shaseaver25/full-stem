...
-- Add preferred_language column to students table (rename from language_preference)
...
BEGIN
  ...
  IF NEW.raw_user_meta_data->>'role' = 'student' THEN
    -- Note: Students won't have a class_id initially, so we use a dummy UUID that will be updated later
    INSERT INTO public.students (
      ...
      'active',
      '00000000-0000-0000-0000-000000000000'::uuid  -- Placeholder class_id
    );
