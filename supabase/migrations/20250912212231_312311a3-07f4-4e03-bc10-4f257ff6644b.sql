-- COMPREHENSIVE LMS CORE MIGRATION (Simplified)
...
-- 3) Ensure class_assignments_new has proper NOT NULL constraints
-- (columns already exist, just ensure they're NOT NULL with defaults)
DO $$ BEGIN
    -- Update selected_components to NOT NULL with default
    ...
    -- Update options to NOT NULL with default  
...
EXCEPTION
    WHEN OTHERS THEN
        -- If columns don't exist or other issues, continue
        NULL;
END $$;
