-- Create missing tables and add comprehensive course content
-- Fix the syntax error by using proper INSERT statements
...
-- Add comprehensive assignments with detailed instructions
...
-- Add essential lesson resources
INSERT INTO lesson_resources (lesson_id, title, resource_type, url, description, order_index)
SELECT 
  l.id,
...
-- Add teacher support materials using INSERT ... SELECT pattern
INSERT INTO teacher_materials (class_id, title, material_type, content, order_index)
SELECT 
  '4c8c238f-5b9d-406c-aff9-bab7112f1b22',
  'Course Pacing Guide', 
  'pacing_guide',
  jsonb_build_object(
