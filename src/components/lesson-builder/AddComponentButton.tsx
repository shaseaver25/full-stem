...
import { Plus, Presentation, FileText, Video, MessageSquare, Code, Calculator, Activity, FileCheck, BarChart, BarChart3, Lightbulb, BookOpen, FolderOpen, CheckCircle2, Layers } from 'lucide-react';
...
const componentTypes = [
  ...
  { type: 'flashcards', label: 'Flashcards', icon: Layers, description: 'Interactive flashcard study and quiz sets' },
  { type: 'poll', label: 'Poll/Survey', icon: BarChart3, description: 'Quick engagement poll with real-time results' },
