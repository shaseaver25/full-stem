...
import { ClassMessaging } from './ClassMessaging';
    ...
    <div className="space-y-6">
      <Tabs defaultValue="assignments" className="w-full">
        <TabsList className="grid w-full grid-cols-3">
          ...
          <TabsTrigger value="publish">Publish Assignments</TabsTrigger>
          <TabsTrigger value="messages">Class Messages</TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="publish">
          <AssignmentPublisher 
            ...
            onPublished={() => {
              ...
              queryClient.invalidateQueries({ queryKey: ['classAssignmentsWithLessons', classId] });
            }}
          />
        </TabsContent>

        <TabsContent value="messages">
          <ClassMessaging classId={classId} />
        </TabsContent>
      </Tabs>
    </div>
  );
